...
$query2 = mysqli_query($conn, $selcat);
			...
			<div class="col-md-12">
				<div class="title text-center">
					<h2>Product Category</h2>
						...
						<?php while($fetch = mysqli_fetch_array($query2)){ ?>
			<div class="col-md-6">
			...
			<div class="col-md-4">
				<div class="product-item">
							...
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">
										<a href="detailpage.php?id=<?php echo $fetch["product_id"] ?>"><i class="tf-ion-ios-search-strong"></i></a>
									</span>
								</li>
								<li>
					...
					<div class="product-content">
						<h4><a href="product-single.html"><?php echo $fetch["product_name"] ?></a></h4>
						<p class="price"><?php echo $fetch["product_price"] ?></p>
					</div>
				</div>
			</div>
			<?php } ?>
